...
<body class="bg-stone-700 text-white">
    ...
    <div class="mx-4 my-52 text-black">
        <div class="p-20 max-w-lg mx-auto mt-24 bg-stone-800 rounded-2xl">
            <header class="text-center">
                ...
                <p class="mb-4 text-white">Create an account</p>
            </header>
            ...
            <form method="POST" action="/users">
                ...
                <div class="mb-6">
                    ...
                    <label for="name" class="inline-block text-lg mb-2 text-eyecandy">
                        Name
                    </label>
                ...
                <div class="mb-6">
                    ...
                    <label for="password" class="inline-block text-lg mb-2 text-eyecandy">
                        Password
                    </label>
                ...
                <div class="mb-6">
                    ...
                    <label for="password2"class="inline-block text-lg mb-2 text-eyecandy">
                        Confirm Password
                    </label>
                ...
                <div class="mt-8">
                    <p class="text-white">
                        ...
                        <a href="/login" class="text-eyecandy hover:text-blue-500 ease-in duration-200">
